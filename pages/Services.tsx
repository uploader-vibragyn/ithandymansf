...
const Services: React.FC = () => {
  return (
    <div className="py-16 px-4 max-w-4xl mx-auto">
      ...
      <p className="text-zinc-500 mb-12">Focused technical solutions for small businesses and independent professionals.</p>
        ...
        {SERVICES.map((service, idx) => (
          <div key={idx} className="bg-white border border-zinc-200 p-8 rounded-xl flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
            ...
            <div className="bg-zinc-50 px-6 py-4 rounded-lg border border-zinc-100 min-w-[160px] text-center">
              <span className="text-xs text-zinc-400 block uppercase tracking-wider mb-1">Starting At</span>
      ...
      <div className="mt-16 bg-zinc-900 text-white p-12 rounded-2xl">
        <h2 className="text-2xl font-light mb-4 text-zinc-100">Looking for something specific?</h2>
        <p className="text-zinc-400 mb-8 max-w-xl">Our team handles complex cloud migrations, custom Python scripting, and emergency network restoration. Talk to our assistant for a bespoke quote.</p>
        <button 
